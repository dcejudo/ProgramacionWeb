...
class Usuario {
	...
	public static function checaUsuario($correo, $pass) {
	...
	public static function getById($id) {
		...
		if ($statement->prepare($sql)) {
			...
			$statement->bind_result($id, $nombre, $email, $password);
	...
	public function insert() {
		...
		if ($statement->prepare($sql)) {
			...
			// Bind parameters
			$statement->bind_param('sss', $this->nombre, $this->email, $this->password);
	...
	public function update() {
		...
		if ($statement->prepare($sql)) {
			...
			// Bind parameters
			$statement->bind_param('sssi', $this->nombre, $this->email, $this->password, $this->id);
